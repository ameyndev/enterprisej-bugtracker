...
<html>
    <head>
        ...
        <title>Delete Bug Reports</title>
    ...
    <body style="background-color:powderblue;">
        <div class="dashboard">
            ...
            <form>
                <input class="btn btn-success" type="button" name="BackToDash" value="< Go Back to Dashboard" onclick="location.href='Dashboard.jsp';">
            </form>
            <h2 align="center">Delete Bug Report</h2><hr>
            ...
            <%
                ...
                PreparedStatement ps = c.prepareStatement("select * from TICKETS");
            ...
            <form action="Deletion.jsp" method="post">
                ...
                <%
                    ...
                    while (rs.next())
                    {
                        ...
                        out.println("<div class='form-check'><input class='form-check-input' type='checkbox' name='bugs' id='bug" + BugCount + "' value='" + EncDec.SCdecrypt(title) +"'><label class='form-check-label' for='bug" + BugCount + "'>" + EncDec.RFdecrypt(name) + " - " + EncDec.SCdecrypt(title) + "</label></div><br>");
                        BugCount++;
                    }
                    %><br>
