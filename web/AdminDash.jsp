...
<html>
    ...
    <body style="background-color:powderblue;">
        <div class="dashboard">
            <nav class="navbar navbar-expand-lg bg-body-tertiary">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="CreateAdminReport.jsp">Create Report</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="ResolveAdminBugs.jsp">Resolve Reports</a>
                    </li>
                    <li class="nav-item">
        ...
        <%
            ...
            out.println("<table class='table'><thead class='table-dark'><th>Sr</th><th>Username</th><th>Title</th><th>Description</th></thead><tbody>");
            int BugCount = 1;
            while (rs.next()) 
            {
