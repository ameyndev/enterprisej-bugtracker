...
<html>
    ...
    <body style="background-color:powderblue;">
        <div class="dashboard">
            ...
            <form>
                <button class="btn btn-success" type="button" name="BackToDash" value="< Go Back to Dashboard" onclick="location.href='Dashboard.jsp';">< Go Back to Dashboard</button>
            </form>
            ...
            <form action="Resolution.jsp" method="post">
                ...
                <%
                    ...
                    while (rs.next())
                    {
                        ...
                        out.println("<div class='form-check'><input type='checkbox' class='form-check-input' name='bugs' id='bug" + BugCount + "' value='" + EncDec.SCdecrypt(title) +"'><label class='form-check-label' for='bug" + BugCount + "'>" + EncDec.SCdecrypt(title) + "</label></div><br>");
                        BugCount++;
                    }
                    %><br>
